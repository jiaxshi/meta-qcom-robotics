...
# matches with: https://github.com/ros2-gbp/octomap-release/archive/release/iron/octomap/1.9.8-3.tar.gz
ROS_BRANCH ?= "branch=release/iron/octomap"
SRC_URI = "git://github.com/ros2-gbp/octomap-release;${ROS_BRANCH};protocol=https"
SRCREV = "d62906c719b0f6cfc318182247ff63087b555456"
S = "${WORKDIR}/git"
